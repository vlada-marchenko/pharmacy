...
import { editProduct } from '@/src/lib/product';
...
export default function EditModal({ onClose, product }: Props) {
    const router = useRouter();
      const params = useParams();
      const shopId = (params.id as string) || Cookies.get('shopId');

      const [photoPreview, setPhotoPreview] = useState(product?.photo || '/pills.png');
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    return;
      ...
      try {
        await editProduct(shopId, {...data, productId: product.id});
                ...
                <div className={css.content}>
                  ...
                  <form className={css.form} onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className={css.buttons}>
                      ...
                      <button  type="button"  className={css.cancel} onClick={handleClose}>
                        Cancel
                      </button>
                    </div>
                  </form>
